        ...
        <div class="card" style="width: 60%; margin: auto; margin-top: 10px; margin-bottom: 10px;">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nameUser" name="nome" value="{{ $medico->nome }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="matricula" name="matricula" value="{{ $medico->matricula }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="{{ $medico->email }}" placeholder="Digite seu email...">
                </div>
                <div class="form-group">
                    <label for="telefone">Número de Celular:</label>
                    <input type="text" class="form-control" id="telefone" name="telefone" value="{{ $medico->telefone }}" placeholder="(81)98833-0009"
